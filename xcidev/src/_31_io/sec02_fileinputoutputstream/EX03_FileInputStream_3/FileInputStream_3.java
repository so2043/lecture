package _31_io.sec02_fileinputoutputstream.EX03_FileInputStream_3;
...
public class FileInputStream_3 {
	...
	public static void main(String[] args) throws IOException {
		...
		// 1. 입력 파일 생성
		File inFile = new File("src/_31_io/sec02_fileinputoutputstream/EX03_FileInputStream_3/FileinputStream.txt");
